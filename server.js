    ...
    setInterval(async function(){
      try{
        ...
        if(js.status==='CONCLUIDA'){
          ...
          if(m){m.innerHTML='PAGO! LIBERADO!';m.style.background='#00a650';m.style.color='#fff';}
        }
      }catch(e){}
    },4000);
  }catch(e){
...
app.listen(PORT,()=>console.log('SLS FINAL OK PORT',PORT));
