// v9.5 SLS WIFI - DESIGN PREMIUM + BOTOES JA PAGUEI + VOUCHER + FIX CERT
...
const PLANOS = {
  "1H": { valor: 3.00, tempo: 60, vel: "5M/5M", nome: "1 HORA", desc: "Ideal para uso rápido" },
  "3H": { valor: 5.00, tempo: 180, vel: "10M/10M", nome: "3 HORAS", desc: "Mais vendido", tag: "MAIS VENDIDO" },
  "24H": { valor: 10.00, tempo: 1440, vel: "10M/10M", nome: "24 HORAS", desc: "Conexão o dia todo" }
};
...
<div class="top"><div style="color:#8b8fa3;font-size:11px;letter-spacing:1px"><span class="dot"></span>ONLINE • 247 CLIENTES CONECTADOS</div>
<div class="logo"><div class="ic">📶</div><div class="sls">SLS WIFI</div></div><div class="sub">Internet rápida • Pagamento instantâneo via PIX</div></div>

<div class="card">
<div class="head"><b>ESCOLHA SEU PLANO</b><span class="badge">⚡ Ativação imediata</span></div>

<div id="p1" class="plano active" onclick="sel('1H')"><div class="row"><div><b>1 HORA</b><div class="small">Ideal para uso rápido</div></div><div style="text-align:right"><div class="price">R$ 3</div><div class="small">1h de acesso</div></div></div></div>
<div id="p2" class="plano" onclick="sel('3H')"><div class="tag">MAIS VENDIDO</div><div class="row"><div><b>3 HORAS</b><div class="small">Mais vendido</div></div><div style="text-align:right"><div class="price">R$ 5</div><div class="small">3h de acesso</div></div></div></div>
<div id="p3" class="plano" onclick="sel('24H')"><div class="row"><div><b>24 HORAS</b><div class="small">Conexão o dia todo</div></div><div style="text-align:right"><div class="price">R$ 10</div><div class="small">24h de acesso</div></div></div></div>
...
<div class="tabs"><div class="tab active" onclick="openTab('pix')">PIX</div><div class="tab" onclick="openTab('pago')">JÁ PAGUEI</div><div class="tab" onclick="openTab('voucher')">VOUCHER</div></div>

<div id="tab-pix" class="panel active"></div>
<div id="tab-pago" class="panel"><p class="small">Se você já pagou e caiu a conexão, clique abaixo:</p><button class="btn2" onclick="jaPaguei()">✅ JÁ PAGUEI - LIBERAR NOVAMENTE</button><div id="msgPago" class="small" style="margin-top:8px"></div></div>
<div id="tab-voucher" class="panel">
<form action="http://10.5
